...
const CreatePost: React.FC = () => {
    ...
    const [Reelfile, setReelsFile] = useState()
...

            {
                loading ? <Progress value={progress} className="w-[60%]" />
                    ...
                    <div className="flex flex-col relative items-center  w-[95%] h-[33rem] box-shadow rounded-lg">
                        <Tabs defaultValue="post" className="w-full justify-center items-center flex-col h-full">
                            <TabsList className=''>
                                <TabsTrigger value="post" className='dark:text-light-text text-dark-text text-xl my-2'>POST</TabsTrigger>
                                <TabsTrigger value="reels" className='dark:text-light-text text-dark-text text-xl my-2'>REELS</TabsTrigger>
                            </TabsList>

                            <TabsContent value="post" className='w-full flex flex-col md:h-[90%] justify-between'>
                            ...
                            <TabsContent value="reels" className='w-full flex flex-col md:h-[90%] justify-between'>
